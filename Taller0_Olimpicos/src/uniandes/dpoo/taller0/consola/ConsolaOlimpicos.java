...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta dado");
	...
	{
		System.out.println("\n" + "País de un atleta dado" + "\n");
		
		String atleta = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.buscarPaisDelAtleta(atleta);
		
		System.out.println("El país del cual proviene el atleta es " + pais + ".");
	}
